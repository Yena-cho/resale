 ...
 */
public class DamoaCharge implements Serializable{
    ...
    public String toString() {
        return new ToStringBuilder(this)
                ...
                .append("rcpStartDt", rcpStartDt)
                .append("rcpStartTm", rcpStartTm)
                .append("rcpEndDt", rcpEndDt)
                .append("rcpEndTm", rcpEndTm)
                .append("rcpPrtEndDt", rcpPrtEndDt)
                .append("rcpPrtEndTm", rcpPrtEndTm)
                .append("cusNm", cusNm)
                .append("smsYn", smsYn)
                .append("mobileNo", mobileNo)
                .append("emailYn", emailYn)
                .append("email", email)
                .append("content1", content1)
                .append("content2", content2)
                .append("content3", content3)
                .append("content4", content4)
                .append("regSeq", regSeq)
                .append("chaTrNo", chaTrNo)
                .append("adjfiGrpCd", adjfiGrpCd)
                .append("payItemNm", payItemNm)
                .append("payItemAmt", payItemAmt)
                .append("payItemYN", payItemYN)
                .append("rcpItemYN", rcpItemYN)
                .append("rcpBusinessNo", rcpBusinessNo)
                .append("rcpPersonNo", rcpPersonNo)
                .append("prtPayItemNm", prtPayItemNm)
                .append("prtContent1", prtContent1)
                .append("prtSeq", prtSeq)
                .toString();
    }
}
