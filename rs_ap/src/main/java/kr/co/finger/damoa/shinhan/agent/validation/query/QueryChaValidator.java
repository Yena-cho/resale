 ...
 */
public class QueryChaValidator implements Validator {
    private static Logger LOGGER = LoggerFactory.getLogger(QueryChaValidator.class);
    ...
    public ValidationResult validate(List<NotiMas> notiMasList, ChacdInfo chacdInfo, MsgIF msgIF) {
        ...
        final String corpCode = queryMessage.getDepositCorpCode().trim();
