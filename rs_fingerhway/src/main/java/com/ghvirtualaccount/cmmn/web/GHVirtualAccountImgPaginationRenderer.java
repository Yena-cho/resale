 ...
 */
package com.ghvirtualaccount.cmmn.web;
 ...
 */
public class GHVirtualAccountImgPaginationRenderer extends AbstractPaginationRenderer implements ServletContextAware{

	private ServletContext servletContext;

	public GHVirtualAccountImgPaginationRenderer() {
		// no-op
	}
