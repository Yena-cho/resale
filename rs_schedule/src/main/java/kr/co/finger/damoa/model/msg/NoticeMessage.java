...
public class NoticeMessage implements CommonMessage {
    ...
    public void setVirtualAccountDivideCount(String virtualAccountDivideCount) {
        this.virtualAccountDivideCount = convert(virtualAccountDivideCount,2);
    }
...
//                .append("type", type)
    ...
    /**
     * 숫자이지만 공백이 들어갈 수 있어 이렇게 처리함..
     * @param index
     * @param amount
     * @param key
     */
    public void setupManyAccountNo(int index, String amount, String key) {
        if (index == 1) {
            setVirtualAccountAmount01(convert(amount+"",13));
            setVirtualAccountKey01(convert(key,5));
        } else if (index == 2) {
            setVirtualAccountAmount02(convert(amount+"",13));
            setVirtualAccountKey02(convert(key,5));
        }else if (index == 3) {
            setVirtualAccountAmount03(convert(amount+"",13));
            setVirtualAccountKey03(convert(key,5));
        }else if (index == 4) {
            setVirtualAccountAmount04(convert(amount+"",13));
            setVirtualAccountKey04(convert(key,5));
        }else if (index == 5) {
            setVirtualAccountAmount05(convert(amount+"",13));
            setVirtualAccountKey05(convert(key,5));
        }else if (index == 6) {
            setVirtualAccountAmount06(convert(amount+"",13));
            setVirtualAccountKey06(convert(key,5));
        }else if (index == 7) {
            setVirtualAccountAmount07(convert(amount+"",13));
            setVirtualAccountKey07(convert(key,5));
        }else if (index == 8) {
            setVirtualAccountAmount08(convert(amount+"",13));
            setVirtualAccountKey08(convert(key,5));
        }else if (index == 9) {
            setVirtualAccountAmount09(convert(amount+"",13));
            setVirtualAccountKey09(convert(key,5));
        }
    }


    private String convert(String value,int length) {
        // 공백이면 공백처리
