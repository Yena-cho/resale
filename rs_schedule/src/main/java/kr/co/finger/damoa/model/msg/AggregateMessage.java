...
//        setSndRcvFlag("1");
    ...
    public Map<String,Object> insertParam() throws ParseException {
        ...
        map.put("RECVCNT", depositTotalNo);
        map.put("RECVAMT", depositTotalAmount);
        map.put("PAYCNT", "0");
        map.put("PAYAMT", "0");
        map.put("RECVCANCELCNT", depositCancelNo);
        map.put("RECVCANCELAMT", depostCancelAmount);
        map.put("ICHECNT", "0");
        map.put("ICHEAMT", "0");
        ...
        map.put("FEECNT", feesNo);
        map.put("FEEAMT", feesAmount);
