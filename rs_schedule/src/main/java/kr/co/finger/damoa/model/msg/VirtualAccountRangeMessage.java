...
public class VirtualAccountRangeMessage implements CommonMessage {
    ...
    private String sndRcvFlag= "1";	//송수신 FLAG
    private String msgTypeCode= "0200";	//전문구분코드(MSG TYPE)
    private String dealTypeCode= "6320";	//거래구분코드
    ...
    private String accountGubun= "";	//계좌발급구분
    private String corpCode= "";	//기관코드
    private String agencyCode= "";	//대리점코드
    private String branchCode= "";	//영업점코드
    private String count= "";	//매수
    private String startVirtualAccount= "0";	//시작가상계좌번호
    private String issuedSerialNo= "0";	//발급일련번호
    ...
    public String getAccountGubun() {
        return accountGubun;
    }

    public void setAccountGubun(String accountGubun) {
        this.accountGubun = accountGubun;
    }
    ...
    public String getStartVirtualAccount() {
        return startVirtualAccount;
    }

    public void setStartVirtualAccount(String startVirtualAccount) {
        this.startVirtualAccount = startVirtualAccount;
    }

    public String getIssuedSerialNo() {
        return issuedSerialNo;
    }

    public void setIssuedSerialNo(String issuedSerialNo) {
        this.issuedSerialNo = issuedSerialNo;
    }
    ...
    public Map<String,Object> toParamMap(String remark) {
        String now = DateUtils.toDTType();
        Map<String, Object> param = new HashMap<>();
        param.put("RULEMNGNO",trim(getUsrWorkArea1()));
        param.put("CHACD",trim(getCorpCode()));
        param.put("ACCCNT",trim(getCount()));
        param.put("SENDST","S");
        param.put("REQTY","M");     // A는 자동, M은 수동
        param.put("APPENDYN","Y");     //
        param.put("REQDT",now);
        param.put("SENDDT",now);
        param.put("REMARK",remark);

        return param;
    }

    public Map<String,Object> toUpdateVaReq(String startNo,String createNo) {
        String now = DateUtils.toDTType();
        Map<String, Object> param = new HashMap<>();
        param.put("RULEMNGNO",trim(getUsrWorkArea1()));
        param.put("STARTACCT",trim(startNo));    // 시작가상계좌번호
        param.put("CREATENO",trim(createNo));
        param.put("SENDST","R");
        param.put("REQTY","M");     // A는 자동, M은 수동
        param.put("RECVDT",now);
        return param;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this)
                ...
                .append("accountGubun", accountGubun)
                .append("corpCode", corpCode)
                .append("agencyCode", agencyCode)
                .append("branchCode", branchCode)
                .append("count", count)
                .append("startVirtualAccount", startVirtualAccount)
                .append("issuedSerialNo", issuedSerialNo)
