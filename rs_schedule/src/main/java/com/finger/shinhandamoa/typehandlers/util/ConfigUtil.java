package com.finger.shinhandamoa.typehandlers.util;

import com.finger.shinhandamoa.typehandlers.crypt.Crypt;
...
import static com.finger.shinhandamoa.typehandlers.util.Constants.*;
...
public final class ConfigUtil {
    ...
    private static String findProperty(String name) {
        ...
        try {
        	valueProperty =  BUNDLE.getString(name);
        } catch (MissingResourceException e) {
        	
        	valueProperty =  DEFAULT_BUNDLE.getString(name);
        }
        log.info(name+"="+valueProperty);
    ...
    private static void initBundleNames() {
        log.info("init default bundle name");
//        INTERNAL_BUNDLE_NAMES.add("");
        ...
        INTERNAL_BUNDLE_NAMES.add("properties");
        INTERNAL_BUNDLE_NAMES.add("application");
        log.info("init default bundle name completed: {}", INTERNAL_BUNDLE_NAMES);
    }
