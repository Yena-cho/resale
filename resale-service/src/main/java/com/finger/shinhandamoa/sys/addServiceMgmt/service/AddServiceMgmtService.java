 ...
 * @desc
 */
public interface AddServiceMgmtService {
    ...
    // 알림톡 발송기관명 수정
    void updateAtChaName(HashMap<String, Object> reqMap) throws Exception;

    void updateAtChaNameHis(HashMap<String, Object> reqMap) throws Exception;
