...
public class ExcelSaveRcpSumReq extends AbstractExcelView2 {
	...
	protected void buildExcelDocument(Map<String, Object> model, XSSFWorkbook workbook, HttpServletRequest request,
        ...
        for(int i = 0; i < idx; i++) {
        	...
        	hRow.createCell(i++).setCellValue("가상계좌 입금");
        	...
        	hRow.createCell(i++).setCellValue("");
        	hRow.createCell(i++).setCellValue("현금영수증 신청");
        	hRow.createCell(i++).setCellValue("");
        	hRow.createCell(i++).setCellValue("합계");
        	hRow.createCell(i++).setCellValue("");
        }
        ...
        for(int i = 0; i < idx; i++) {
        	hRow.createCell(i++).setCellValue("");
        	hRow.createCell(i++).setCellValue("건수(건)");
