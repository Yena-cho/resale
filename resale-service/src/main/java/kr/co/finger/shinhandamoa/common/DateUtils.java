...
public class DateUtils {
    ...
    public static Date parseDate(String dateString, String pattern, Date defaultValue) {
        Date settleDate;
        try {
            settleDate = new SimpleDateFormat(pattern).parse(dateString);
        } catch (Exception e) {
