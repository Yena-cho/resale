...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <strong>가상계좌거래개시전문내역</strong>
            </li>
        </ol>
        <p class="page-description">가상계좌거래 개시전문내역을 조회하는 화면입니다.</p>
    </div>
    <div class="col-lg-2">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form>
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    <label class="form-label block">관리정보</label>
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div class="checkbox checkbox-primary checkbox-inline">
                                            <input type="checkbox" id="tty001" value="001" name="rcpTy" onclick="fn_rcpTychecked();">
                                            <label for="tty001"> 개시 </label>
                                        </div>
                                        <div class="checkbox checkbox-primary checkbox-inline">
                                            <input type="checkbox" id="tty002" value="002" name="rcpTy" onclick="fn_rcpTychecked();">
                                            <label for="tty002"> 재개시 </label>
                                        </div>
                                        <div class="checkbox checkbox-primary checkbox-inline">
                                            <input type="checkbox" id="tty003" value="003" name="rcpTy" onclick="fn_rcpTychecked();">
                                            <label for="tty003"> 종료 </label>
                                        </div>
                                        <div class="checkbox checkbox-primary checkbox-inline">
                                            <input type="checkbox" id="tty004" value="004" name="rcpTy" onclick="fn_rcpTychecked();">
                                            <label for="tty004"> 종료예고 </label>
                                        </div>
                                        <div class="checkbox checkbox-primary checkbox-inline">
                                            <input type="checkbox" id="tty005" value="005" name="rcpTy" onclick="fn_rcpTychecked();">
                                            <label for="tty005"> 장애 </label>
                                        </div>
                                        <div class="checkbox checkbox-primary checkbox-inline">
                                            <input type="checkbox" id="tty006" value="006" name="rcpTy" onclick="fn_rcpTychecked();">
                                            <label for="tty006"> 장애회복 </label>
                                        </div>
                                        <div class="checkbox checkbox-primary checkbox-inline">
                                            <input type="checkbox" id="tty007" value="007" name="rcpTy" onclick="fn_rcpTychecked();">
                                            <label for="tty007"> TEST-CALL </label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div class="checkbox checkbox-primary checkbox-inline">
                                            <input type="checkbox" id="sendS" value="0800" name="sendReceive" onclick="fn_sendReceivechecked();">
                                            <label for="sendS"> 수신 </label>
                                        </div>
                                        <div class="checkbox checkbox-primary checkbox-inline">
                                            <input type="checkbox" id="receiveR" value="0810" name="sendReceive" onclick="fn_sendReceivechecked();">
...
<script type="text/javascript">
    ...
    function fn_sendReceivechecked() {
        if (!$('#sendS').is(':checked') || !$('#receiveR').is(':checked')) {
    ...
    function fn_rcpTychecked() {
        if (!$('#tty001').is(':checked') || !$('#tty002').is(':checked') || !$('#tty003').is(':checked') || !$('#tty004').is(':checked') || !$('#tty005').is(':checked') || !$('#tty006').is(':checked') || !$('#tty007').is(':checked'))  {
    ...
    function fnSearch(page) {
        ...
        var sndrcvSt = $("input[name='sendReceive']:checked").val();
        ...
        checkbox.map(function (i) {
            ...
            var url = "/sys/vanoMgmt/getVanoTranInitCheck";
    ...
    function fnGrid(result, obj) {
        ...
        if (result == null || result.count <= 0) {
            ...
            $.each(result.list, function (i, v) {
                ...
                str += '<td>' + NVL(v.transTy) + '('+ NVL(v.transTyNm) +')</td>';
