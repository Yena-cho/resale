...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <p class="page-description">현금영수증 데이터를 조회하는 화면입니다.</p>
    </div>
    <div class="col-lg-2">
                    ...
                    <div class="ibox-content">
                        <form>
                            <div class="row">
                                    ...
                                    <div class="form-group form-group-sm">
                                        <div class="input-group col-md-12">
                                            ...
                                            <div class="daterange-setMonth">
                                                ...
                                                <button type="button" class="btn btn-sm btn-primary btn-outline" name="btnSetMonth2"  id="btnSetMonth2_1"  onclick="setMonthTerm2(1);">1개월</button>
                                                <button type="button" class="btn btn-sm btn-primary btn-outline" name="btnSetMonth2"  id="btnSetMonth2_6"  onclick="setMonthTerm2(6);">6개월</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <label class="form-label block">요청일자</label>
                                    <div class="form-group form-group-sm">
                                        <div class="input-group col-md-12">
                                            <div class="input-daterange input-group float-left" id="datepicker3">
                                                <input type="text" class="input-sm form-control"  id="startDate3" name="startDate3" readonly="readonly"/>
                                                <span class="input-group-addon">to</span>
                                                <input type="text" class="input-sm form-control" id="endDate3" name="endDate3" readonly="readonly"/>
                                            </div>

                                            <div class="daterange-setMonth">
                                                <button type="button" class="btn btn-sm btn-primary btn-outline active" name="btnSetMonth3" id="btnSetMonth0_3" onclick="setMonthTerm3(0);">전체</button>
                                                <button type="button" class="btn btn-sm btn-primary btn-outline" name="btnSetMonth3"  id="btnSetMonth3_1"  onclick="setMonthTerm3(1);">1개월</button>
                                                <button type="button" class="btn btn-sm btn-primary btn-outline" name="btnSetMonth3"  id="btnSetMonth3_6"  onclick="setMonthTerm3(6);">6개월</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label block">현금영수증 발행 데이터 오류 여부</label>
                                    <div class="form-group form-group-sm">
                                        <div class="input-group col-md-12">
                                            <div class="radio radio-primary radio-inline">
                                                <input id="createErrorCashReceipt_0" type="radio" name="createErrorCashReceipt" value="" checked="checked" />
                                                <label for="createErrorCashReceipt_0"> 전체 </label>
                                            </div>
                                            <div class="radio radio-primary radio-inline">
                                                <input id="createErrorCashReceipt_1" type="radio" name="createErrorCashReceipt" value="Y">
                                                <label for="createErrorCashReceipt_1"> 정상 </label>
                                            </div>
                                            <div class="radio radio-primary radio-inline">
                                                <input id="createErrorCashReceipt_2" type="radio" name="createErrorCashReceipt" value="N">
                                                <label for="createErrorCashReceipt_2"> 오류 </label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <label class="form-label block">현금영수증 미발행 오류 여부</label>
                                    <div class="form-group form-group-sm">
                                        <div class="input-group col-md-12">
                                            <div class="radio radio-primary radio-inline">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label block">현금영수증 중복발행 오류 여부</label>
                                    <div class="form-group form-group-sm">
                                        <div class="input-group col-md-12">
                                            <div class="radio radio-primary radio-inline">
                                                <input id="duplicationIssuedErrorCashReceipt_0" type="radio" name="duplicationIssuedErrorCashReceipt" value="" checked="checked" />
                                                <label for="duplicationIssuedErrorCashReceipt_0"> 전체 </label>
                                            </div>
                                            <div class="radio radio-primary radio-inline">
                                                <input id="duplicationIssuedErrorCashReceipt_1" type="radio" name="duplicationIssuedErrorCashReceipt" value="Y">
                                                <label for="duplicationIssuedErrorCashReceipt_1"> 정상 </label>
                                            </div>
                                            <div class="radio radio-primary radio-inline">
                                                <input id="duplicationIssuedErrorCashReceipt_2" type="radio" name="duplicationIssuedErrorCashReceipt" value="N">
                                                <label for="duplicationIssuedErrorCashReceipt_2"> 오류 </label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<!-- 현금영수증번호 상세보기 -->
<jsp:include page="/WEB-INF/views/include/modal/admin/cash-receipt/detailPopUp-cashmasCd.jsp" flush="false"/>

<!-- 기관명 상세보기 -->
<jsp:include page="/WEB-INF/views/include/modal/admin/cash-receipt/detailPopUp-chaName.jsp" flush="false"/>

<!-- 거래일시 상세보기 -->
<jsp:include page="/WEB-INF/views/include/modal/admin/cash-receipt/detailPopUp-regDt.jsp" flush="false"/>
...
function fnSearch(page) {
    ...
    var startday3 = $('#startDate3').val().replace(/\./gi, "");
    var endday3   = $("#endDate3").val().replace(/\./gi, "");
    ...
    var param = {
        ...
        endDate2: endday2,
        startDate3: startday3,
        endDate3: endday3,
        sveCd: $("input[name=sveCd]:checked").val(),
        createErrorCashReceipt: $("input[name=createErrorCashReceipt]:checked").val(),
        notIssuedErrorCashReceipt: $("input[name=notIssuedErrorCashReceipt]:checked").val(),
        duplicationIssuedErrorCashReceipt: $("input[name=duplicationIssuedErrorCashReceipt]:checked").val(),
    ...
    if(history.pushState) {
        history.pushState(param, '발행 현황', '/sys/cash-receipt/status-by-issue?' + $.param(param));
    }

	$.ajax({
		type : "get",
		async : true,
		url : '/sys/rest/cash-receipt/status-by-issue',
...
function fnGrid(result, obj) {
    ...
    $.each(result.itemList, function (i, v) {
        ...
        $('<td><a href="#" onclick="detailPopUp_cashmasCd(\''+ v.cashmasCd +'\')">' + NVL(v.cashmasCd) + '</td>').appendTo($tr);
        $('<td>' + NVL(v.chaCd) + '</td>').appendTo($tr);
        $('<td><a href="#" onclick="detailPopUp_chaName(\''+ v.chaCd +'\')">' + NVL(v.chaName) + '</td>').appendTo($tr);
        $('<td>' + NVL(v.cusName) + '</td>').appendTo($tr);
        $('<td><a href="#" onclick="detailPopUp_regDt(\''+ v.rcpmasCd +'\')">' + NVL(v.regDt) + '</td>').appendTo($tr);
        ...
        $('<td>' + NVL(v.sendDt) + '</td>').appendTo($tr);
        ...
        if(v.cusType == null || v.confirm == null){
            v.errorInfo = '발행번호 구분 없음';
        }else if(v.cusType == null){
            v.errorInfo = '발행번호 없음';
        }

        if(v.cusType == '1'){
            if(v.confirm != '11' && v.confirm != '12'){
                v.errorInfo = '발행번호 구분 오류';
            }
        }else if(v.cusType == '2'){
            if(v.confirm != '21'){
                v.errorInfo = '발행번호 구분 오류';
        ...
        if(v.cusType == '1' && v.confirm == '11'){ //핸드폰번호
            if(!(((v.cusoffNo).length == 10 || (v.cusoffNo).length == 11) && (v.cusoffNo).substring(0,2) != '01')){
                v.errorInfo = '발행번호 오류(휴대폰번호)';
            }
        }else if(v.cusType == '1' && v.confirm == '12'){ //현금영수증카드번호
            if((v.cusoffNo).length != 18){
                v.errorInfo = '발행번호 오류(현금영수증카드번호)';
            }
        }else if(v.cusType == '2' && v.confirm == '21'){ //사업자번호
            if(!((v.cusoffNo).length == 10 && (v.cusoffNo).substring(0,1) != '0')){
                v.errorInfo = '발행번호 오류(사업자번호)';
            }
        }

        $('<td>' + NVL(v.errorInfo) + '</td>').appendTo($tr);
...
function detailPopUp_cashmasCd(param){
    $("#detail-cashmasCd").modal({
        backdrop: 'static',
        keyboard: false
    });

    funDetailPopUp_cashmasCd(param);
}

function detailPopUp_chaName(param){
    $("#detail-chaName").modal({
        backdrop: 'static',
        keyboard: false
    });

    funDetailPopUp_chaName(param);
}

function detailPopUp_regDt(param){
    $("#detail-regDt").modal({
        backdrop: 'static',
        keyboard: false
    });

    funDetailPopUp_regDt(param);
}
...
function setMonthTerm2 (val) {
    ...
    if(val != 0) {
        ...
        $('#btnSetMonth2_' + val).addClass('active');
    } else {
        ...
        $("button[name=btnSetMonth2]").removeClass('active');
        $('#btnSetMonthAll2').addClass('active');
    }
}

function setMonthTerm3 (val) {
    $('#searchDate3').val(val);
    var toDate = new Date();

    if(val != 0) {
        $('#startDate3').attr('disabled', false);
        $('#endDate3').attr('disabled', false);

        $('#endDate3').val(getDateFormatDot(toDate));
        $('#startDate3').val(monthAgo($('#endDate3').val(), val));

        $("button[name=btnSetMonth3]").removeClass('active');
        $('#btnSetMonth3_' + val).addClass('active');
    } else {
        ...
        $("button[name=btnSetMonth3]").removeClass('active');
        $('#btnSetMonthAll3').addClass('active');
    }
}
...
function fn_fileSave() {
	...
	swal({
        ...
        var url = '/sys/rest/cash-receipt/status-by-issue/download?' + $.param(param);
