...
<script>
    ...
    function fnSearch(page) {
        ...
        var url = "/sys/addServiceMgmt/pastPaymentHistListAjax";
    ...
    function fnGrid(result, obj) {
        ...
        if (result.count <= 0) {
            ...
            $.each(result.list, function (i, v) {
                str += '<tr>';
                str+='<input type="hidden" id="rcpMasCd" name="rcpMasCd" value="' + v.rcpMasCd + '">';
                str+='<td>';
                str += '<div class="checkbox checkbox-primary checkbox-inline">';
                str+='<input name="checkList" type="checkbox" id="row-'+v.rn+'" value="'+v.rcpMasCd+'" rcpMasSt="'+v.rcpMasSt+'" onclick="fn_listCheck();">';
            ...
            swal({
                ...
                if(result.value == true) {
                    $('input:checkbox[name=checkList]:checked').each(function(i) {
                        ...
                        if($(this).attr('rcpMasSt') == '완납' || $(this).attr('rcpMasSt') == '일부납' || $(this).attr('rcpMasSt') == '초과납'){
                        }else{
                            swal({
                                type: 'info',
...
<form id="pdfMakeForm" name="pdfMakeForm" method="post" action="/org/receiptMgnt/admPastPayPdfMakeRcpBill">
    ...
    <input type="hidden" id="amtChkTy" name="amtChkTy" value="N"/>
</form>

<form id="fileForm" name="fileForm" method="post" action="/sys/addServiceMgmt/pastPaymentHistExcelDown">
...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <strong>과거입금내역조회</strong>
            </li>
        </ol>
        <p class="page-description">이용기관별 과거입금내역을 조회하는 화면입니다.</p>
    </div>
    <div class="col-lg-2">
