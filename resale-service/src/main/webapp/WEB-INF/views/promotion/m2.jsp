...
<head>
    <meta charset="utf-8">
    <title>가상계좌 수납관리 서비스 : 어린이집 및 유치원</title>
        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img usemap="#m1" src="/assets/promotion/img/m2/m01.jpg" alt="m1"/>
                </div>
                <div class="swiper-slide">
                    <img usemap="#m2" src="/assets/promotion/img/m2/m02.jpg" alt="m2"/>
                </div>
                <div class="swiper-slide">
                    <img usemap="#m3" src="/assets/promotion/img/m2/m03.jpg" alt="m3"/>
                </div>
                <div class="swiper-slide">
                    <img usemap="#m4" src="/assets/promotion/img/m2/m04.jpg" alt="m4"/>
                </div>
            </div>
