...
<head>
    <meta charset="utf-8">
    <title>가상계좌 수납관리 서비스 모바일 안내장</title>
        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img usemap="#m1" src="/assets/promotion/img/m1/m01.jpg" alt="m1"/>
                </div>
                <div class="swiper-slide">
                    <img usemap="#m2" src="/assets/promotion/img/m1/m02.jpg" alt="m2"/>
                </div>
                <div class="swiper-slide">
                    <img usemap="#m3" src="/assets/promotion/img/m1/m03.jpg" alt="m3"/>
                </div>
                <div class="swiper-slide">
                    <img usemap="#m4" src="/assets/promotion/img/m1/m04.jpg" alt="m4"/>
                </div>
            </div>
            ...
            <map name="m1">
                <area shape="rect" alt="상담문의" title="상담문의" coords="42,674,303,740" href="tel:02-786-8201" target="_self"/>
                <area shape="rect" alt="홈페이지" title="홈페이지" coords="320,675,579,738" href="https://www.shinhandamoa.com" target="_self"/>
            </map>
