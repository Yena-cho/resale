...
function fn_ListCollector(num) {
	...
	var url = "/bank/getCollectorListAjax";
	var param = { 
		curPage : moPage,
		chaCd   : $('#popChacd').val(),
...
function fnGridCollector(result, obj) {
	...
	if(result.count <= 0){
		...
		$.each(result.list, function(k, v){
			...
			str +=  '<td>'+ nullValueChange(v.agtCd) +'</td>';			
			str += '</tr>';
		});
...
<div class="modal fade" id="lookup-collecter-popup" tabindex="-1" role="dialog" aria-labelledby="regPayer" aria-hidden="true">
