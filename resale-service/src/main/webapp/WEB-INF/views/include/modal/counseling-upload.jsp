...
<script type="text/javascript">
    ...
    function fn_fileUpload() {
        ...
        if (!fn_checkFileType(fileNM)) {
            ...
            var url = "/sys/uploadExcelCounsel";
        }
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            swal({
                                type: 'success',
                                text: '등록을 완료하였습니다. 성공: '+ data.successCnt + '건, 실패: ' + data.failCnt + '건',
                                confirmButtonColor: '#3085d6',
                                confirmButtonText: '확인'
                            }).then(function (result) {
                                $('#uploadfile').val('');
                                $('#fileNM').val('');
                                $("#popup-counseling-upload").modal("hide");
                                    search();
                            });
                        }, error: function (data) {
                            swal({
...
<div class="modal fade" id="popup-counseling-upload" tabindex="-1" role="dialog" aria-labelledby="regPayer" aria-hidden="true">
                ...
                <div class="container-fluid">
                    <div class="row row-eq-height">
                        <form class="form-horizontal" id="fileForm" name="fileForm" enctype="multipart/form-data" method="post">
                                <div class="col-md-3 col-sm-12">전화상담업로드</div>
