    ...
    $(function () {
        $('#certBtn').click(function () {
            ...
            if (rowCnt <= 0) {
                ...
                $("#popup-choose-certificate").modal("hide");
...
<div class="modal fade" id="popup-choose-certificate" tabindex="-1" role="dialog" aria-labelledby="regPayer"
     aria-hidden="true">
                        ...
                        <div class="row">
                            <div class="col-12 mt-3 mb-2">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" id="tableCheckbox1" name="sorting-order-type" value="cert1">
                                    <label for="tableCheckbox1"><span class="mr-2"></span>교육비 납입증명서</label>
                                </div>
                            </div>
                            <div class="col-12 mb-2">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" id="tableCheckbox2" name="sorting-order-type" value="cert2">
                                    <label for="tableCheckbox2"><span class="mr-2"></span>장기요양급여 납부확인서</label>
                                </div>
                            </div>
                            <div class="col-12 mb-5">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" id="tableCheckbox3" name="sorting-order-type" value="cert3">
