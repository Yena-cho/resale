...
<div class="inmodal modal fade" id="popup-collecter-info" tabindex="-1" role="dialog" aria-labelledby="regPayer"
     aria-hidden="true">
    <div class="modal-dialog modal-big" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h5 class="modal-title">이용기관 상세정보</h5>
            </div>
...
<%--                                            </div>--%>
<%--                                            <div class="radio radio-primary radio-inline">--%>
<%--                                                <input type="radio" id="RdoChatrty2" value="03" name="RdoChatrty" checked>--%>
<%--                                                <label for="RdoChatrty2">API</label>--%>
<%--                                            </div>--%>
<%--                                            <div class="radio radio-primary radio-inline">--%>
<%--                                                <input type="radio" id="RdoChatrty3" value="05" name="RdoChatrty" checked>--%>
...
<%--                                        </td>--%>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="radio radio-primary radio-inline">
                                                <input type="radio" id="RdoChast1" value="ST06" name="RdoChast">
                                                <label for="RdoChast1">정상</label>
                                            </div>
                                            <div class="radio radio-primary radio-inline">
                                                <input type="radio" id="RdoChast2" value="ST08" name="RdoChast">
                                                <label for="RdoChast2">정지</label>
                                            </div>
                                            <div class="radio radio-primary radio-inline">
                                                <input type="radio" id="RdoChast3" value="ST02" name="RdoChast">
                                                <label for="RdoChast3">해지</label>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <th>주소 *</th>
                                        <td colspan="3">
                                            <div class="form-group form-group-sm m-b-xxs">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div id="enable-validate-amount">
                                                <div class="radio radio-primary radio-inline">
                                                    <input type="radio" class="validateAmountAndPeriod" id="enable-validate-amount-true" value="Y" name="enableValidateAmount"/>
                                                    <label for="enable-validate-amount-true">사용(청구방식)</label>
                                                </div>
                                                <div class="radio radio-primary radio-inline">
                                                    <input type="radio" class="validateAmountAndPeriod" id="enable-validate-amount-false" value="N" name="enableValidateAmount" />
                                                    <label for="enable-validate-amount-false">미사용(통지방식)</label>
                                                </div>
                                                <div class="radio radio-primary radio-inline">
                                                    <input type="radio" class="validateAmountAndPeriod" id="enable-validate-amount-limit" value="L" name="enableValidateAmount" />
                                                    <label for="enable-validate-amount-false">한도방식</label>
                                                </div>
                                            </div>
                                        </td>
                                        <th>부분납 사용여부</th>
                                        <td>
                                            <div id="enable-partial-payment">
                                                <div class="radio radio-primary radio-inline">
                                                    <input type="radio" class="kAndPeriod" id="enable-partial-payment-true" value="Y" name="enablePartialPayment" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div id="enable-validate-period">
                                                <div class="radio radio-primary radio-inline">
                                                    <input type="radio" class="validateAmountAndPeriod" id="enable-validate-period-true" value="Y" name="enableValidatePeriod"/>
                            ...
                            <div class="col-lg-12">
                                <table class="table table-bordered white-bg table-align-center" id="adj-table">
                                    ...
                                    <tr id="acc1">
                                        ...
                                        <td class="form-group">
                                            <div class="col-sm-3 p-0">
                                                <select class="form-control bankCd" id="bankCd1"></select>
                                            </div>
                                            <div class="col-sm-7">
...
<%--                                            <div class="col-sm-2 p-0 text-right">
                                    ...
                                    <tr class="accInfoTr" id="acc2">
                                        ...
                                        <td class="form-group">
                                            <div class="col-sm-3 p-0">
                                                <select class="form-control bankCd" id="bankCd2"></select>
                                            </div>
                                            <div class="col-sm-7">
...
<%--                                            <div class="col-sm-2 p-0 text-right">
                                    ...
                                    <tr class="accInfoTr" id="acc3">
                                        ...
                                        <td class="form-group">
                                            <div class="col-sm-3 p-0">
                                                <select class="form-control bankCd" id="bankCd3"></select>
                                            </div>
                                            <div class="col-sm-7">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("input:radio[class='validateAmountAndPeriod']").click(function () {
            if ($(this).val() === 'Y') {    // 수납방식 : 승인 / 부분납
                ...
                $("#enable-validate-amount-limit").prop("checked", true);
                $("#enable-validate-period-false").prop("checked", true);
                $("#enable-partial-payment-false").prop("checked", true);
            }
        });
        ...
        $("#popup-collecter-info").on("hidden.bs.modal", function() {
    ...
    function collector_info_init(thisId) {
        fn_bankList();
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var map = data.info;
                // 기관기본정보
                $("#chaCd").text(map.chaCd);
                $(":radio[name=bankId]").val([map.fgCd]);
                $(":radio[name=RdoChatrty]").val([map.chatrty]);
                $("#rcpNoticeUrl").val(map.rcpNoticeUrl);
                $("#chaApiUrlQuery").val(map.chaApiUrlQuery);
                $("#chaApiUrlNotice").val(map.chaApiUrlNotice);

                $("#chaName").val(map.chaName);
                $("#chaoffno").val(map.chaOffNo);
                $("#owner").val(map.owner);
                if (map.ownerTel != null && map.ownerTel != '') {
                    var ownertel = map.ownerTel;
                    ownertel = ownertel.split('-');
                    $("#ownertel1").val(ownertel[0]);
                    $("#ownertel2").val(ownertel[1]);
                    $("#ownertel3").val(ownertel[2]);
                } else {
                    $("#ownertel1").val("");
                    $("#ownertel2").val("");
                    $("#ownertel3").val("");
                }
                $("#usePurpose").val(map.usePurpose);
                nowChaSt = map.chast;
                $(":radio[name=RdoChast]").val([map.chast]);
                $("#chaStatus").val(map.chaStatus);
                $("#chaType").val(map.chaType);
                $("#chrname").val(map.chrName);
                if (map.chrTelNo != null && map.chrTelNo != '') {
                    var chrtelno = map.chrTelNo;

                    chrtelno = chrtelno.split('-');
                    $("#chrtelno1").val(chrtelno[0]);
                    $("#chrtelno2").val(chrtelno[1]);
                    $("#chrtelno3").val(chrtelno[2]);
                } else {
                    $("#chrtelno1").val("");
                    $("#chrtelno2").val("");
                    $("#chrtelno3").val("");
                ...
                $("#chaaddress1").val(map.chaAddress1);
                $("#chaaddress2").val(map.chaAddress2);
                $("#chazipcode").val(map.chaZipCode);
                ...
                $("#feeaccno").val(map.fingerFeeAccountNo);
                $("#feebankcode").val(map.fingerFeeBankCode);
                (map.fingerFeePayty ==  "PRE") ? $("#feepayty").prop("checked", true) : $("#feepayty").prop("checked", false)

                $(":radio[name=enableAdjustmentAccount]").val([map.adjaccyn]);
                $(":radio[name=enableValidateAmount]").val([map.amtChkTy]);
                $(":radio[name=enablePartialPayment]").val([map.partialPayment]);
                $(":radio[name=enableValidatePeriod]").val([map.rcpDueChk]);
                $(":radio[name=cusNameTy]").val([map.cusNameTy]);

                $(":radio[name=rcpReceiptTy]").val([map.rcpReqTy]);
                $(":radio[name=noTaxYn]").val([map.noTaxYn]);
                $(":radio[name=rcpReqSveTy]").val([map.rcpReqSveTy]);
                $(":radio[name=mnlRcpReqTy]").val([map.mnlRcpReqTy]);
                $(":radio[name=rcpReceipt]").val([map.rcpReqYn]);
                $(":radio[name=mandRcp]").val([map.mandRcpYn]);

                // 다계좌정보
                var j = 0;
                $.each(data.accountList, function (i, v) {
                    j = v.adjfiregKey.substring(4,5)
                    $("#acc" + j).find(".grpadjname").val(v.grpAdjName);
                    $("#acc" + j).find(".bankCd").val(v.bankCd);
                    $("#acc" + j).find(".accno").val(v.realAccno);
                });

                $("#notlimit").val(map.notMinLimit).keyup();
                $("#flatfingerfee").val(numberToCommas(map.notMinFee)).keyup();
                $("#notfingerfee").val(numberToCommas(map.notCntFee)).keyup();
                $("#rcpcntfee").val(numberToCommas(map.rcpCntFee));
                $("#rcpbnkfee").val(numberToCommas(map.rcpBnkFee)).focusout();

                $("#daMngMemo").val(map.daMngMemo);
    ...
    function saveChaIfoSYS() {
        ...
        param = {
            ...
            , fingerFeeBankCode: $("#feebankcode").val()
            ...
            if (!result.value) {
              ...
              $.ajax({
                ...
                success: function (result) {
                    ...
                    swal({
                        type: 'success',
                        text: '기관정보 수정이 완료되었습니다.',
                        confirmButtonColor: '#3085d6',
                        confirmButtonText: '확인'
                    }).then(function () {
                        $("#popup-collecter-info").modal("hide");
                        pageChange();
                    });
                }
            });
