...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({		
	...
	$ON_ATTACHPHOTO_OPEN_WINDOW : function(){			
		this.htPopupOption.sUrl = this.makePopupURL(this.oApp.bucketName);
	 ...
	 */
	makePopupURL : function(bucketName){
		var sPopupUrl = "./photo_uploader/popup/photo_uploader.html?bucketName="+bucketName;
