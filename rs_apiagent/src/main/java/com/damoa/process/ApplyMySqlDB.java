...
public class ApplyMySqlDB extends ApplyDB{
    ...
    public MirRecord selectPayData() throws UserException, Exception{
        ...
        qry	= "\n 		  SELECT   recordtype, "
                ...
                + "\n                  rcpprtendtm, "
                + "\n                  cusnm, "
                + "\n                  IFNULL(smsyn, 'N') as smsyn, "
                + "\n                  mobileno, "
                + "\n                  IFNULL(emailyn, 'N') as emailyn, "
                + "\n                  email, "
                + "\n                  content1, "
                + "\n                  content2, "
                + "\n                  content3, "
                ...
                + "\n                  payitemnm, "
                + "\n                  payitemamt, "
                + "\n                  IFNULL(payitemyn, 'N') as payitemyn, "
                + "\n                  IFNULL(rcpitemyn, 'N') as rcpitemyn, "
                + "\n                  rcpbusinessno, "
                + "\n                  rcppersonno, "
                + "\n                  prtpayitemnm, "
                + "\n                  prtcontent1, "
