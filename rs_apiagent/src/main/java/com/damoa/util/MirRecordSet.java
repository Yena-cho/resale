 ...
 * @author Mir
 *
 * <br>반복하는 데이터 집합용 클래스. Hashtable이 모인 Vector임. 필드명은 대문자가 기본.<br>
 *<pre>
 ...
 *
 *for (condition) {
 *    ht.put(fieldName1, fieldValue1);
 *    ht.put(fieldName2, fieldValue2);
 *    ht.put(fieldName3, fieldValue3);
 *     .
 *     .
 *  mirREC.add(ht);
 *} // end for
 ...
 *hashtable뿐만 아니라 object도 넣을 수 있다.
 *</pre>
 *<pre>
 *MirRecord mir = new MirRecord();
 *MirRecordSet mirREC = new MirRecordSet();
 ...
 *
 *mir.setRec("REC", mirREC);
 *hashtable뿐만 가능한 세팅법. more()부터 써주고 해당 레코드셋(인덱스)의 값을 세팅해야 함.
 *</pre>
 */
@SuppressWarnings("rawtypes")
public class MirRecordSet extends Vector {
    /**
	 * 
	 */
	private static final long serialVersionUID = -3466271013009421944L;
    ...
    public String getFieldString(String fieldNm) {
        return (String)((Hashtable)get(index)).get(fieldNm.toUpperCase());
    } // end getFieldString
    ...
    public Object get(String fieldNm) {
        return ((Hashtable)get(index)).get(fieldNm.toUpperCase());
    } // end get

    /**
     * 현재 레코드셋 포인터의 HashTable 반환
     * @return String 필드값
     */
